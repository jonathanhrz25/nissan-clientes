...
if (!empty($_POST['email']) && !empty($_POST['password'])) {
  ...
  if (count($results) > 0 && password_verify($_POST['password'], $results['password'])) {
    ...
    header("Location: ./index-piso.php");
  } else {
...
<head>
  ...
  <title>Iniciar sesión-Hostess</title>
</head>
...
<h1>Iniciar sesión - Hostess</h1>
<span>ó <a href="signupHostess.php">Regístrate</a></span>


<form action="loginHostess.php" method="POST">
