  ...
  <div class="container">
    <div class="mx-auto">
      ...
      <nav class="nav">
        ...
        <a class="nav-link" href="http://localhost/nissan-clientes/php/hoja-hostess.php">Generar Hoja de Prospecto - Hostess</a>
        <a class="nav-link" href="http://localhost/nissan-clientes/php/tabla-hostess.php">Ver Tabla</a>
      </nav>
        <a class="navbar-brand"></a>
        <ul class="nav nav-pills">
          <li class="nav-item">
              <a class="cerrar" href="http://localhost/nissan-clientes/login/indexHostess.php">Cerrar Sesión</a></li>
            </ul>
          </li>
        </ul>
      </nav>
